  ...
  render(){
    ...
    <h1 className='f1   '>Add Customer</h1>
          ...
          <div>
           ...
           <input  className='c1 text-center' type='text' placeholder='Enter Id' onChange = { e => this.setState({ Id: e.target.value })} value={this.state.Id} />
          </div>


           <div>
            <label className='a1'>Customer name</label>
            <input  className='c1 text-center' type='text' placeholder='Enter Customer Name' onChange = { e => this.setState({ CustomerName: e.target.value })} value={this.state.CustomerName} />
           </div>

           <div>
            <label className='a1'>Phone Number</label>
            <input   className='c1 text-center'  type='text' placeholder='Enter Phone Number' onChange = { e => this.setState({ PhoneNumber: e.target.value })} value={this.state.PhoneNumber} />
           </div>

           <div>
            <label className='a1'>Address</label>
            <input  className='c1 text-center' type='text' placeholder='Enter Address' onChange = { e => this.setState({ Address: e.target.value })} value={this.state.Address} />
           </div>
